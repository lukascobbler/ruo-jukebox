...
export class SongTableComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.recommendedSongsDataSource = [
      ...
      { id: '10', no: 1, title: 'Title', album: 'Album', albumId: '10', duration: 420, artist: 'Awesome Artist 123', artistId: '10', lyrics: 'No lyrics found' },
      { id: '11', no: 1, title: 'Title', album: 'Album', albumId: '11', duration: 420, artist: 'Awesome Artist 123', artistId: '11', lyrics: 'No lyrics found' },
      { id: '12', no: 1, title: 'Title', album: 'Album', albumId: '12', duration: 420, artist: 'Awesome Artist 123', artistId: '12', lyrics: 'No lyrics found' },
      { id: '13', no: 1, title: 'Title', album: 'Album', albumId: '13', duration: 420, artist: 'Awesome Artist 123', artistId: '13', lyrics: 'No lyrics found' },
      { id: '14', no: 1, title: 'Title', album: 'Album', albumId: '14', duration: 420, artist: 'Awesome Artist 123', artistId: '14', lyrics: 'No lyrics found' },
      { id: '15', no: 1, title: 'Title', album: 'Album', albumId: '15', duration: 420, artist: 'Awesome Artist 123', artistId: '15', lyrics: 'No lyrics found' },
      { id: '16', no: 1, title: 'Title', album: 'Album', albumId: '16', duration: 420, artist: 'Awesome Artist 123', artistId: '16', lyrics: 'No lyrics found' },
      { id: '17', no: 1, title: 'Title', album: 'Album', albumId: '17', duration: 420, artist: 'Awesome Artist 123', artistId: '17', lyrics: 'No lyrics found' },
      { id: '18', no: 1, title: 'Title', album: 'Album', albumId: '18', duration: 420, artist: 'Awesome Artist 123', artistId: '18', lyrics: 'No lyrics found' },
      { id: '19', no: 1, title: 'Title', album: 'Album', albumId: '19', duration: 420, artist: 'Awesome Artist 123', artistId: '19', lyrics: 'No lyrics found' },
    ];
  }
