...
import { MusicalContentComponent } from './components/user/entity-pages/musical-content/musical-content.component';
...
export const routes: Routes = [
  ...
  { path: 'musical-content/:id', component: MusicalContentComponent, canActivate: [authGuard, roleGuard], data: { roles: ['User'] as Role[] } },
